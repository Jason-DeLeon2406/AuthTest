...
class UserController extends Controller
{
    ...
    {
        $roles = Role::pluck('name','name')->all();return view('users.create',compact('roles'));}
        /**
        ...
        public function update(Request $request, $id)
        {
            ...
            $user = User::find($id);$user->update($input);DB::table('model_has_roles')->where('model_id',$id)->delete();
